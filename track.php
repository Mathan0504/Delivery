...
<div class="col-lg-12">
	<div class="card card-outline card-dark text-center">
		<div class="card-body">
			<div class="d-flex w-100 px-1 py-2 justify-content-center align-items-center">
				<label for="">Track Order using Tracking ID</label>
			</div>
				<div class="input-group col-sm-12">
                    <input type="search" id="ref_no" class="form-control form-control" placeholder="Enter your item tracking number here">
                    <div class="input-group-append">
                        <button type="button" id="track-btn" class="btn btn-outline-success">
