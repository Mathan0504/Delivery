	...
	<div class="card card-outline card-dark">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-outline-success " href="./index.php?page=new_staff">Add New Staff Member</a>
			</div>
		</div>
		<div class="card-body">
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group btn-toolbar">
		                        <a href="index.php?page=edit_staff&id=<?php echo $row['id'] ?>" class="btn btn-outline-warning ">
		                          <i class="fas fa-edit"></i>
		                        </a>
		                        <button type="button" class="btn btn-outline-danger delete_staff" data-id="<?php echo $row['id'] ?>">
