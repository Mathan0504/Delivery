<div class="container-fluid">
	<form action="" id="update_status">
		...
		<div class="form-group">
			...
			<?php $status_arr = array("Pickup Accepted by Pick&GO","Collected","Shipping Inititated","In-Transit","Arrived At Destination","Delivery Inititated","Pickup Inititated","Delivered","Pickup Successful","Failed Delivery Attempt"); ?>
